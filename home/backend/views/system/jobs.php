...
<div class="container">
    <div class="public-nav">您当前的位置：<a href="">系统</a><a href="">职位设置</a></div>
    <div class="public-content">
        ...
        <div class="public-content-cont">
            <table class="public-cont-table">
                <tr>
                    <th style="width:30%"><input type="checkbox">职位分类</th>
                ...
                <tr>
                    ...
                    <td>
                        <div class="table-fun">
                            <a href="?r=system/jobsadd&id=<?php echo $value['id']?>">添加</a>

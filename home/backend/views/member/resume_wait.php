                ...
                <tr>
                    ...
                    <th width="40%">
                        <div style="float:right">
                            <?=Html::beginForm(['member/resume_wait'],'get')?>
...
<div class="box">
    ...
    <table width="100%" cellspacing="6" cellpadding="0" border="0" align="center">
        ...
        <input type="hidden" name="win" value="resume_wait">
        <tr>
            <td height="30"> </td>
            <td height="30">
...
<script>
    ...
    $(document).on("click","#flush",function(){
        ...
        window.location="index.php?r=member/resume_wait";
    })
    ...
    $(document).on("click","#del",function(){
        ...
        $.ajax({
            ...
            success:function(msg){
                if(msg==1){
                    alert('批量删除成功');window.location='index.php?r=member/resume_wait';
                }
            }

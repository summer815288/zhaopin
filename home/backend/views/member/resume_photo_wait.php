                ...
                <tr>
                    ...
                    <th width="40%">
                        <div style="float:right">
                            <?=Html::beginForm(['member/resume_talent_wait'],'get')?>
...
<div class="box">
    ...
    <table width="100%" cellspacing="6" cellpadding="0" border="0" align="center">
        ...
        <input type="hidden" name="win" value="resume_talent_wait">
        <tr>
            <td height="30"> </td>
            <td height="30">
...
<div class="boxs">
    ...
    <table width="100%" cellspacing="6" cellpadding="0" border="0" align="center">
        <input type="hidden" name="ids" class="hid" >
        <input type="hidden" name="win" value="resume_photo_wait">
        <tr>
            <td height="30"> </td>
            <td height="30">
                <strong style="color:#0066CC; font-size:14px;">将所选简历设置为：</strong>
...
<script>
    ...
    $(document).on("click","#flush",function(){
        ...
        window.location="index.php?r=member/resume_photo_wait";
    })
    ...
    $(document).on("click","#del",function(){
        ...
        $.ajax({
            ...
            success:function(msg){
                if(msg==1){
                    alert('批量删除成功');window.location='index.php?r=member/resume_photo_wait';
                }
            }

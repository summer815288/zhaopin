...
<head>
    ...
    <style>
       ...
       .left{
        ...
        .cao{
            background-color: #e7e7e7; color: #333;display: block;font-size: 14px;height: 40px;line-height: 40px;margin-bottom: 5px;text-align: center;width: 127px;margin-left: 35px;;
        }
...
<!--附件上传-->
    ...
    <div class="left">
        ...
        <div style="background-color: #e7e7e7; color: #333;display: block;font-size: 14px;height: 40px;line-height: 40px;margin-bottom: 5px;text-align: center;width: 127px;margin-left: 35px;;"><a href="javascript:;"  id="invite"   resume_id="<?php echo $_GET['id'] ?>">邀请面试</a></div>

...
<div id="container">
    ...
    <div class="content">
        <dl class="company_center_content">
            <dt><h1><em></em>已申请职位</h1></dt>

            <dd style="padding:30px 0px;">
                <ul class="ji" >
                    <li  class="selected"  >所有<span style="color:#808080">（<?=$count?>）</span></li>
                    <li >企业未查看<span style="color:red">（<?=$count2?>）</span></li>
                    <li>企业已查看<span style="color:#808080">（<?=$count3?>）</span></li>
                ...
                <div class="con">
                    ...
                    <table class="btm" style="text-align:center;margin-left: 35px;" >
                      ...
                      <tr>
                          ...
                          <td><?=date('Y-m-d H:i:s',$v['apply_addtime'])?></td>
                      </tr>
                      <?php  }?>
                      </tbody>
                    </table>

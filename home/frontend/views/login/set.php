...
<div id="body">
    		...
    		<ul id="navheader" class="reset">
            	...
            	<dt>
                	...
                	<dd style="display: none;"><a href="list.html">我要找工作</a></dd>
                                                <dd style="display: none;"><a href="?r=login/loginset">帐号设置</a></dd>
                                <dd class="logout" style="display: none;"><a rel="nofollow" href="?r=login/loginout">退出</a></dd>
            </dl>
                                </div>
    </div><!-- end #header -->
    <div id="container">
    ...
    <dl id="user_sideBarmenu" class="user_sideBarmenu">
     	        <dt><h3>帐号设置</h3></dt>
                <dd><a class="hover" href="?r=login/loginset">帐号绑定</a></dd>
        <dd><a href="?r=login/updatepwd">修改密码</a></dd>
            </dl>
</div>
